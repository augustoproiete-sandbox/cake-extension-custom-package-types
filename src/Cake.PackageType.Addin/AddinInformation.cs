...
namespace Cake.PackageType.Addin
{
    internal static class AddInInformation
    {
        ...
        internal static string AssemblyName => _assemblyName;

        internal static string AssemblyVersion => _assemblyVersion;

        internal static string InformationalVersion => _informationalVersion;
